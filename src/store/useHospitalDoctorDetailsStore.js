...
const useHospitalDoctorDetailsStore = create(
  persist(
    (set, get) => ({
      ...initialState,
    ...
    {
      name: 'hospital-doctor-details-storage',
      getStorage: () => localStorage, // default is localStorage, but being explicit is fine.
    }
  )
);
