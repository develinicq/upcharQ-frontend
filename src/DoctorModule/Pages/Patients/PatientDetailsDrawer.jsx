...
export default function PatientDetailsDrawer({
    ...
    const gender = basicInfo.gender ? (basicInfo.gender.charAt(0).toUpperCase() + basicInfo.gender.slice(1).toLowerCase()) : (patient?.genderInitial || patient?.gender || "-");
    ...
    const contact = contactInfo.primaryPhone || patient?.contactNumber || patient?.contact || "-";
                ...
                {loadingDetails ? (
                    ...
                    <>
                        <div className="">
                            ...
                            <div className="flex gap-2 px-3 bg-white">
                                {tabs.map(tab => (
                                    <button
                                        key={tab}
                            ...
                            {activeTab === "Overview" && (
                                <>
                                    ...
                                    <div className="flex flex-col gap-4 pt-3 px-3 pb-3">
                                        <div className="flex flex-col gap-1">
                                            ...
                                            <div className="border-t border-secondary-grey100/50 pt-2 flex flex-col gap-2">
                                                <div className="flex items-center gap-2 text-sm">
                                                    ...
                                                    <span className="min-w-[18px] px-1 py-0.5 rounded-sm text-xs border border-warning2-50 text-warning2-400 bg-warning2-50">Primary</span>
                                        ...
                                        <div className="flex flex-col gap-1">
                                            <h3 className="text-sm font-medium text-secondary-grey400">Last Visit</h3>
                                                ...
                                                {recentAppointments.length > 0 ? (
                                                    <div className="space-y-2">
                                                        <div className="flex justify-between">
                                                            <span>Date:</span>
                                                            <span className="font-medium">{formatDate(recentAppointments[0].date)}</span>
                                                        </div>
                                                        <div className="flex justify-between">
                                                            <span>Type:</span>
                                                            <span className="font-medium">{recentAppointments[0].type || "Consultation"}</span>
                                                        </div>
                                                        <div className="flex justify-between">
                                                            <span>Status:</span>
                                                            <span className="text-success-300 bg-success-100 px-1 rounded-sm">{recentAppointments[0].status || "Completed"}</span>
                                                        </div>
                                                    </div>
                                                ) : (
