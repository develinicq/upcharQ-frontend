...
export default function FDActivated({ onCompleteProfile }) {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col relative overflow-hidden font-sans">
      ...
      {/* Header / Logo */}
      <div className="w-full flex justify-center pt-8 z-10 mt-4">
        <img src="/logo.svg" alt="Upchar-Q" className="h-10" />
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 z-10">
        <div className="w-full max-w-2xl flex flex-col items-center">
          ...
          <div className="text-center mb-8">
            <h1 className="text-md font-bold text-gray-700 mb-1">
              Your Profile Activated Successfully
            </h1>
            <p className="text-[10px] text-gray-600 max-w-xl mx-auto">
              Your credentials and professional contacts are now secured. You're ready to access front desk data.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between w-full gap-4 px-4 sm:px-12">
            <Button
              variant="secondary"
              className="w-full sm:w-auto px-3 py-1 rounded-sm border-gray-300 text-gray-700 font-medium hover:bg-gray-50 text-[11px]"
              onClick={() => {
                if (onCompleteProfile) return onCompleteProfile();
                // Assuming standard onboarding completion leads here or profile completion page
                navigate('/fd/settings/profile');
              }}
            >
            ...
            <Button
              variant="primary"
              className="w-full sm:w-auto px-3 py-1 rounded-sm bg-blue-600 hover:bg-blue-700 text-white font-normal flex items-center justify-center gap-2 text-[11px]"
              onClick={() => navigate('/fd/queue')}
            >
              Go to Dashboard
